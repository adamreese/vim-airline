...
function! airline#themes#hybrid#refresh()
    ...
    let g:airline#themes#hybrid#palette.normal_modified = {
                \ 'airline_c': airline#themes#get_highlight2(['Text', 'fg'], ['SpellRare', 'bg'])
                \ }
    ...
    let s:I1 = airline#themes#get_highlight2(['Text', 'fg'], ['DiffText', 'bg'])
    let s:I2 = airline#themes#get_highlight2(['Text', 'fg'], ['SpellLocal', 'bg'])
    let s:I3 = airline#themes#get_highlight2(['Text', 'fg'], ['SpellCap', 'bg'])
    ...
    let s:V2 = airline#themes#get_highlight2(['Text', 'fg'], ['DiffDelete', 'bg'])
    let s:V3 = airline#themes#get_highlight2(['Text', 'fg'], ['Error', 'bg'])
    ...
    let s:IA = airline#themes#get_highlight('Pmenu')
